...
public class ServicoDecorrerArray {
    ...
    public ServicoDecorrerArray(ArrayList<String> local_Partida, ArrayList<String> local_Chegada,  ArrayList<String> Local_PartidaCoordenadas,
